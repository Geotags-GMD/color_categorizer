...
class ColorCategorizer:
    ...
    def initGui(self):
        ...
        if not self.toolbar:
            self.toolbar = self.iface.addToolBar('Color Categorizer')
        
        # Add the action to the toolbar
        self.action = QAction(QIcon(self.icon_path), 'Categorize Layer by Color', self.iface.mainWindow())
